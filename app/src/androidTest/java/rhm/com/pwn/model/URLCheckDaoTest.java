...
public class URLCheckDaoTest {
    ...
    public void getURLCheck() throws Exception {
        ...
        URLCheck urlc = db.urlCheckDao().getURLCheck(list.get(0).intValue());
    ...
    public void insertAll() throws Exception {
        ...
        URLCheck urlcRead1 = db.urlCheckDao().getURLCheck(list.get(0).intValue());
        URLCheck urlcRead2 = db.urlCheckDao().getURLCheck(list.get(1).intValue());
        URLCheck urlcRead3 = db.urlCheckDao().getURLCheck(list.get(2).intValue());
    ...
    public void updateUsers() throws Exception {
        ...
        db.urlCheckDao().updateUser(urlcRead2);
        List<URLCheck> listUrlc = db.urlCheckDao().getAll();
    ...
    public void checkGeneratorItem1() throws Exception {
        ...
        URLCheck urlcRead = db.urlCheckDao().getURLCheck(list.get(0).intValue());
        List<URLCheck> listUrlc = db.urlCheckDao().getAll();
