 ...
 */
public class URLEditFragment extends Fragment {
...
//    private OnFragmentInteractionListener mListener;
    ...
    public static URLEditFragment newInstance(String url) {
        URLEditFragment fragment = new URLEditFragment();
